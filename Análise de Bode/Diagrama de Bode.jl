...
# ╔═╡ 7e427596-6426-11ed-19dc-550bc91dd818
begin	
...
# ╔═╡ 2a46ca25-6430-472e-9443-0ceac059fce8
md"""
# Diagrama de Bode
"""

# ╔═╡ be7a95f1-57ba-47dc-a4a7-beb7432e5850
md"""
## 1.
```math
G(s)H(s) = \frac{100 \cdot (s+10)}{(s^2 + 10s)}
```
```math
G(s)H(s) = \frac{(100s+1000)}{(s^2 + 10s)}
```
"""

# ╔═╡ d6913ea7-8755-47e4-a1f8-d230abf03da8
y1 = tf(
	[100,1000],
	[1,10,0]
)

# ╔═╡ 0d8fea62-895b-47b5-867c-904d6700aa3b
marginplot(y1;
	xticks=exp10.(-2:0.5:4),
)

# ╔═╡ dacdc1a2-6f8f-419c-8440-16a64f394d0e
md"""
$$-180 + MF = -90$$
$$MF = 90$$
"""

# ╔═╡ 2fdce70d-f68a-4b9b-90d9-7d1745acf892
md"""
Como o valor da fase nunca atinge o valor de -180 graus, a margem de ganho é infinita. Portanto, o sistema não tenda a instabilidade pelo critédio de Bode.

$$MG = \infty$$
"""

# ╔═╡ d6625d57-d1fe-442c-86d4-5d1b7ff8713d
md"""
## 2.
```math
G(s)H(s) = \frac{1}{s(s+5)(s+8)}
```
```math
G(s)H(s) = \frac{1}{(s^3+13s^2+40s)}
```
"""

# ╔═╡ ad648f44-c40d-4c06-b20b-14dff17520ad
y2 = tf(
	[1],
	[1,13,40,0]
)

# ╔═╡ a82a97c5-06b3-4c4e-95a3-d932cab2bd58
begin
...
# ╔═╡ 69039c13-c5f6-4f87-ba88-c7d12a1895b6
md"""
$$0 + MG = 520,18$$
$$MG = 520,18$$
"""

# ╔═╡ 2c2ca9f5-140f-4d48-9d58-f23bfcc6ab5b
md"""
$$Pm = 89,53$$
"""

# ╔═╡ c23b62dd-7ad8-4d11-ac7c-38be344582e7
md"""
## 3.
```math
G(s)H(s) = \frac{16}{(s+2)(s+4)}
```
```math
G(s)H(s) = \frac{16}{(s^2+6s+8)}
```
"""

# ╔═╡ 13e444fc-1b00-4373-9a50-432cb49acec5
y3 = tf(
	[16],
	[1,6,8]
)

# ╔═╡ 8ec9597d-6f4a-42f2-94ee-6d4150cad51a
marginplot(y3,
	xticks=exp10.(-2:0.3:4),
)

# ╔═╡ 026fcadf-1514-4821-896a-b194ed467051
md"""
$$-180 + MF = -86,74$$
$$MF = 93,26$$
"""

# ╔═╡ e661ae5b-0f24-4da6-a3d8-b085b8a25af3
md"""
Como o valor da fase nunca atinge o valor de -180 graus, a margem de ganho é infinita. Portanto, o sistema não tenda a instabilidade pelo critédio de Bode.
