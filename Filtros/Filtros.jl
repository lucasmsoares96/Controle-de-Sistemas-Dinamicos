...
# ╔═╡ 39ea977f-b3b0-48e1-9578-75c976775df1
begin
...
# ╔═╡ 2fd6df15-6032-48df-a3f6-e30a5ae357ae
md"""
# Filtros
"""

# ╔═╡ 1d508cc1-eee3-44b1-841a-a74e0c1a2e43
const ⋅ = *

# ╔═╡ 9364be01-2b4b-4e87-8b4d-98f361953fda
md"""
## Questão 1
Filtro passa baixa, inversor de primeira ordem
```math
H_a(S) = \frac{-R_2/R_1}{\omega_c R_2 C_1 S + 1}
```
"""

# ╔═╡ d6500e15-2029-4c04-b76d-57bf3d874478
begin
	R1 = 10
	R2 = R1
	f₁ = 1000
...
# ╔═╡ a38ee50f-9fd1-46c1-b138-81f29c5cb106
md"""
## Questão 2
Filtro passa baixa de segunda ordem topologia sallen key
```math
H_{a1}(S) = \frac{1}{\omega_{c}^2 R_1 R_2 C_1 C_2 S^2 + \omega_c C_1 (R_1 + R_2)S + 1}
```
"""

# ╔═╡ 7b7365a7-3057-471c-ac7d-4acb1980c9ad
begin
	R₁ = 10
	R₂ = R1      
	f₂ = 1000
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "0d84eacd4929e139261357d018f2e6fe5a4590e3"
