...
# ╔═╡ 84aad777-9cb2-45ff-baff-f34a607016d1
begin
...
# ╔═╡ 51537d06-c252-4305-ac93-4ff9bb09739c
md"""
# Sistemas de Primeira e Segunda Ordem
"""

# ╔═╡ aecb402b-7306-4e40-94e7-eb8df2907823
const ⋅ = *

# ╔═╡ 607ec6e3-d22d-431b-bc08-f4f3da0d546d
md"""
Escolha um sistema de primeira ordem e um sistema de segunda ordem, na forma canonica, em resposta ao degrau:
1. Usando o XCOS obtenha os gráficos de saída;
1. Obtenha os diagramas de Bode
1. Baseado nos resultados gráficos discuta sobre o sistema de primeira e o sistema de segunda ordem.
1. Variando ξ nos blocos
    - 1.0
    - 0.7
    - 0.4
    - 0.0
...
# ╔═╡ 5c1548b5-8eaf-45cc-a2fd-85f5cb6fc3d9
md"""
## Primeira ordem
"""

# ╔═╡ eb932220-a767-454a-bc52-6afcabdf203c
md"""
### Forma canônica
```math
G(s) = \frac{k}{\tau s + 1}
...
# ╔═╡ 87e95505-c748-4a0f-a949-ee0d04118962
md"""
### Constantes
- k → valor final(permanente)
- τ → 63% de k 
"""

# ╔═╡ 69d0f69d-e2d2-4f46-877b-abc2f9dee86d
md"""
### Equação
```math
G(s) = \frac{10}{s+20}
...
# ╔═╡ 4218a807-5b7e-4f41-9ebd-25a9adaf354e
md"""
### Malha Aberta
"""

# ╔═╡ 1d29864b-d5e5-48e8-ac84-abce453a0b39
md"""
#### Diagrama de Blocos
"""

# ╔═╡ 3f1dcb82-4294-481f-8cae-afcc01c1524d
LocalResource("primeira ordem/diagrama malha aberta.png")

# ╔═╡ e20f8360-1474-4321-a643-326214f20320
md"""
#### Saída
"""

# ╔═╡ 54b610b6-673c-461f-a010-3737fcddcf0b
LocalResource("primeira ordem/saida malha aberta.png")

# ╔═╡ 15b59a3a-130a-49ad-997f-8e4904c89da6
md"""
### Malha Fechada
"""

# ╔═╡ 9383cfa5-5a08-4f6a-85e5-a098442b2432
md"""
#### Diagrama de Blocos
"""

# ╔═╡ 69feaf46-2468-4661-8dbd-ee66c964d472
LocalResource("primeira ordem/diagrama malha fechada.png")

# ╔═╡ 9f699183-44c8-461c-aacd-c4ab455874ea
md"""
#### Saída
"""

# ╔═╡ e69ef0df-d4a4-4afe-be79-90f341f164a7
LocalResource("primeira ordem/saida malha fechada.png")

# ╔═╡ 6c7e916c-119d-4d87-a3b3-ad2fe08e30ed
md"""
### Diagrama de Bode
"""

# ╔═╡ f2140715-0294-4870-b5a5-2cf8e14014f6
begin
	h₁ = tf(
		[10],
		[1, 20]
	...
	bodeplot(h₁,
		xticks=exp10.(0:0.5:3)
	)
end

# ╔═╡ ae1f09f7-e3cd-4fe1-ae23-22681feb6701
md"""
## Segunda Ordem
"""

# ╔═╡ f034202f-bd95-46ce-a184-d87a3cccaddf
md"""
### Forma Canônica
```math
...
# ╔═╡ 5512441b-c2a7-4b19-9df6-ff81a55c9c51
md"""
### Constantes
- ωₙ → frequeência natural do sistema
- ξ  → fator de amortecimento
- A → ganho
"""

# ╔═╡ 531d52f6-8a08-48bf-a9af-c8469ead8045
md"""
### Equação
```math
G(s) = \frac{100}{(s+4)(s+6)}
= A ⋅ \frac{24}{s^2 + 10s + 24}
```
```math
= 4.1 \cdot \frac{24}{s^2 + 10s + 24}
```
"""

# ╔═╡ 3c640a4e-f7c2-41f9-acbf-b333f02f4943
md"""
### Malha Aberta
"""

# ╔═╡ 4ab56ac1-61a0-4c42-a5d6-789892a85426
md"""
#### Diagrama de Blocos
"""

# ╔═╡ f3e0611d-13ee-4e1a-b196-8e8570838298
LocalResource("segunda ordem/diagrama malha aberta.png")

# ╔═╡ a5507bdc-1eb4-4d1d-898b-93785de9b725
md"""
#### Saída
"""

# ╔═╡ 7baf04d4-d02b-44b3-b4ae-8b641a53e6e1
LocalResource("segunda ordem/saida malha aberta.png")

# ╔═╡ e86f064f-23db-4b72-9ee5-af13e0e473c1
md"""
### Malha Fechada
"""

# ╔═╡ d85cbdf8-674d-438a-bc24-623c047664cf
md"""
#### Diagrama de Blocos
"""

# ╔═╡ 07531037-1b6d-49e0-af40-bd3faf4cd9a3
LocalResource("segunda ordem/diagrama malha fechada.png")

# ╔═╡ a01380e2-6580-4a72-a153-0c2bb145877a
md"""
#### Saída
"""

# ╔═╡ c9d1e1d4-391e-4f86-94cf-3f2fd436acf8
LocalResource("segunda ordem/saida malha fechada.png")

# ╔═╡ 7c768957-eaa0-4a15-86ea-156803f419f3
md"""
### Diagrama de Bode
"""

# ╔═╡ 76e0ed51-4294-4e3a-9d53-b4ea329904b8
begin
	h₂ = tf(
		[100],
		[1,10,24]
	...
	bodeplot(h₂,
		xticks=exp10.(0:0.5:2);
	)
end

# ╔═╡ 775d1307-9f0b-444a-b8ce-0963a6868cd7
md"""
### Comentários
Ao comparar os gráficos de saída dos sistemas de primeira e segunda ordem, podemos perceber que no gráfico de segunda ordem existem uma pequena oscilação para cima antes do sistema entrar em estabilidade, o que não acontece no sistema de primeira ordem.
"""

# ╔═╡ 217c7227-13fc-4af3-b0eb-5d255a973f2d
md"""
## Variação do ξ
"""

# ╔═╡ dca03f54-36de-4bac-9dd2-0a12423ceb39
md"""
```math
\omega_n^2 = 24
```
```math
\omega_n = \sqrt{24} = 4.89
```
"""

# ╔═╡ 6285710e-5e91-4c21-8871-22d7e5ea13b3
md"""
O segundo termo do denominador na forma canônica é encontrado da seguinte forma:
```math
2 \xi \omega_n s
```
"""

# ╔═╡ b77d0147-2be0-41e8-b6b5-021be1e9cbd3
md"""
para ξ = 1.0 temos:
```math
2* 1.0 * 4.89 = 9.8
...
# ╔═╡ 3cb4a062-6d8e-4ea3-8d75-a6c8b00b8d86
LocalResource("Xi/1.0.png")

# ╔═╡ 59c9973f-97d9-4f83-a8f6-c27a4db7012d
md"""
para ξ = 0.7 temos:
```math
2* 0.7 * 4.89 = 6.86
...
# ╔═╡ baee5231-1a4b-4847-b0d8-a00656ffc8d1
LocalResource("Xi/0.7.png")

# ╔═╡ 576ad432-db89-46ac-8b35-6e16c637aa4b
md"""
para ξ = 0.4 temos:
```math
2* 0.4 * 4.89 = 3.92
...
# ╔═╡ 664ed8a2-a870-470c-bb2d-2c3edb37d2ea
LocalResource("Xi/0.4.png")

# ╔═╡ aa0b9bbb-49c0-493b-a684-dee684456f02
md"""
para ξ = 0.0 temos:
```math
2* 0.0 * 4.89 = 0.0
...
# ╔═╡ 9717fedb-53a8-4196-bdd2-439b22f48d2c
LocalResource("Xi/0.0.png")

# ╔═╡ ee0b0bec-c560-41f7-81c4-c39769d3333b
md"""
### Comentário
Ao comparar as saídas para cada valor de ξ, podemos perceber que quanto mais o valor do ξ se aproxima de 0 o sistema se aproxima da instabilidade e quanto mais o valor de ξ se aproxima de 1, mais ele se parece com um sistema de primeira ordem.
"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "1efd7ed053738675bb7fc80a8931ea3a6a855c07"
...
git-tree-sha1 = "1cb9621cefcc34a958d418734e570837ba99823d"
