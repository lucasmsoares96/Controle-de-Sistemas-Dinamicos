...
# ╔═╡ 3f9a3a3a-b7ec-11ed-1dc2-a9567d21464c
begin
...
# ╔═╡ 36d52571-07ed-4636-9158-71d4cfdb65a1
md"""
# Equações Diferencias Ordinárias
"""

# ╔═╡ cb48278a-5e5e-4b8a-bb3e-3e844d23782e
md"""
## Primeira Ordem
"""

# ╔═╡ bb1c4aa8-bd86-4eb4-b654-ac4414524dd3
begin
	f1(y, p, t) = y^2 - y * sin(t) - 10;    # Equação
	y₀ = 0.0                                # condição inicial
	t = (0.0, π)                            # intervalo de tempo
	prob = ODEProblem(f1, y₀, t)            # Define EDO
	sol = solve(prob)                       # solução
	plot(sol)
end

# ╔═╡ f475b69a-fe17-4995-afd0-8f5053aa8b90
md"""
## Segunda Ordem
"""

# ╔═╡ f033fbc6-bcf6-43b1-89cd-0bd42ffb6def
begin
	f2(du, u, p, t) = -0.1du - 0.8u
	u₀ = 5e-3
	du₀ = 0.0
	t2 = (0.0, 30.0)
	prob2 = SecondOrderODEProblem(f2, du₀, u₀, t2)
	sol2 = solve(prob2)
end

# ╔═╡ 77f131e1-b7bd-40db-b405-e69c771cb621
begin
	ts = LinRange(t2[1], t2[2], 200)
	z = sol2(ts, Val{0})   # z = (̇u, u)
	dz = sol2(ts, Val{1})  # ̇z = (̈u, ̇u)
	plot(ts, [z[2, :] z[1, :] dz[1, :]])
end

# ╔═╡ f6df31da-4e65-4593-890e-e4660e0f2919
begin
	plot(sol2)
	ddu(t) = f2(sol2(t)[1], sol2(t)[2], nothing, t)
	tt = range(t2..., length=200)
	plot!(tt, ddu)
end
