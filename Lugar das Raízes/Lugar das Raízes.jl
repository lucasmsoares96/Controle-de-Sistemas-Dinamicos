...
# ╔═╡ 14e7d2f5-28df-4f4c-b80c-5c03f1f73c20
md"""
## Exemplos
"""

# ╔═╡ fc056fbd-cbb6-4774-9c3d-5b583e52260a
md"""
### 1
"""

# ╔═╡ 7e1f90fd-48c0-45ae-9ffa-a3216678a557
md"""
```math
X(s) = \frac{2s^2+5}{s^2+3s+2}
```
"""

# ╔═╡ 8b7fc716-f1a0-4fcf-8212-f4351c49e413
sys1 = tf(
	[2,0,5],
	[1,3,2]
)

# ╔═╡ b668281f-ab18-48dc-9856-a8ccfd6ee2b9
rlocusplot(sys1)

# ╔═╡ 94f90b8d-f4a2-4f26-a79a-75eb01d86309
md"""
Os valores correspondem aos encontrados matemáticamente
"""

# ╔═╡ a345caaa-a823-4c01-9579-5ac291dd4814
md"""
### 2
"""

# ╔═╡ 93e4c2b8-8b3e-40b0-b55b-0faf49238553
md"""
```math
X(s) = \frac{6(s+34)}{s(s^2+10s+34)} = \frac{6s+204}{s^3+10s^2+34s}
```
"""

# ╔═╡ 9e2d5eed-a8ad-4b53-9f12-9b21c9e5023a
sys2 = tf(
	[6,204],
	[1,10,34,0]
)

# ╔═╡ c993426d-4b4c-4c6d-ac5b-ddcb933b6bf9
rlocusplot(
	sys2, 
	xlims=(-40, 10)
)

# ╔═╡ 51326019-9013-49d7-ab62-a39c6a712601
md"""
Os valores correspondem aos encontrados matemáticamente
"""

# ╔═╡ 547a02dd-1e0f-4183-b0cd-f7bdde8e0051
md"""
$$G(s) = \frac{100(s+2)}{(s+1)(s+10)}$$
$$H(s) = 1$$
"""

# ╔═╡ 59394a36-6e81-4b55-a557-1baf5f7ab1f2
md"""
então a função de transferência do diagrama de bode é:

$$G(s)H(s) = \frac{100(s+2)}{(s+1)(s+10)}$$
"""

# ╔═╡ 18913789-6804-49d0-9251-d4685b9f0e06
md"""
## Exercícios
"""
...
# ╔═╡ b7329cd2-dded-44bd-aa20-ccfbe172d7e4
md"""
como nosso objetivo é minimizar o erro, devomos sumar um à G(s)H(s) pois:

$E = r - h.y(s)$
"""

# ╔═╡ e2e4d467-80c4-4368-8f10-e30bec247d6d
md"""
$$1 \pm G(s)H(s) = 1+ 100 \cdot \frac{(s+2)}{(s+1)(s+10)}$$
"""

# ╔═╡ 28501774-90ae-4aab-b18e-b378ef21e98a
md"""
### 2
Plote o LGR, o Bode e a saída y(t) usando o diagrama de blocos (XCOS do scilab)
"""

# ╔═╡ d96ca177-5e51-4943-9cad-58bb07c84294
h₁ = tf(
	[100,200],
	[1, 11, 10]
)

# ╔═╡ 85a6af79-fb76-413f-88e3-f2104992ca0c
rlocusplot(h₁)

# ╔═╡ 6f269e72-df94-444e-ba5b-36d5063f6e6f
marginplot(h₁,
	xticks=exp10.(0:0.5:3)
)

# ╔═╡ c283e6ba-511c-4b3f-954d-ed5fc784f7b1
LocalResource("./2/malha fechada.png")

# ╔═╡ 8fe6bebc-9905-4e86-84d5-d0ebd79c51ca
LocalResource("./2/saída.png")

# ╔═╡ 6a57f303-3c66-40cb-b0e3-6548fc6b1f1f
md"""
### 3
Acrescente um polo na origem na função de transferência em malha aberta e plote o LGR, o Bode e a saída y(t) usando o diagrama de blocos (XCOS do scilab). Comente as diferenças percebidas com o acréscimo do polo.
"""

# ╔═╡ 73a2959f-89e5-405d-ba5e-14a1221b9420
h₃ = tf(
	[100,200],
	[1, 11, 10, 0]
)

# ╔═╡ aac11013-aa9b-422a-8939-48396b11407d
rlocusplot(h₃)

# ╔═╡ c9bfbfe0-420d-48fb-b524-48706b66b9c4
marginplot(h₃,
	xticks=exp10.(0:0.5:3)
)

# ╔═╡ 1eea81b4-d928-4124-b943-ed4ff391517f
LocalResource("./3/malha fechada.png")

# ╔═╡ c464688e-149f-4a06-8c3b-eb23bb1f0561
LocalResource("./3/saída.png")

# ╔═╡ af671e72-2308-4245-8359-3a89e73dc93c
md"""
### 4
Acrescente um zero na origem na função de transferência em malha aberta e plote o LGR, o Bode e a saída y(t) usando o diagrama de blocos (XCOS do scilab). Comente as diferenças percebidas com o acréscimo do zero.
"""

# ╔═╡ caa77978-c2b4-4cca-ab6b-0366df9bf981
h₄ = tf(
	[100,200,0],
	[1, 11, 10]
)

# ╔═╡ 7d70fb31-3c90-4c48-a6d9-04795832da97
rlocusplot(h₄)

# ╔═╡ 258fa844-a58d-468b-82b6-327eb57a3205
marginplot(h₄,
	xticks=exp10.(0:0.5:3)
)

# ╔═╡ 7bf9b119-ba3b-426a-992f-1d58a65d0195
LocalResource("./4/malha fechada.png")
